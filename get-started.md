...
<div class="justify-center md:justify-start flex flex-wrap md:flex-nowrap mb-6 md:space-y-0 space-x-14 space-y-4 space-x-reverse">
    <p>Duis nec nullam volutpat diam. Leo mauris blandit mi ac imperdiet posuere. Est facilisi nisi, turpis viverra mi
        arcu.</p>
    <button class="btn btn--black">GitHub</button>
</div>

<div class="justify-center dm:justify-start flex flex-wrap md:flex-nowrap mb-6 md:space-y-0 space-x-14 space-y-4 space-x-reverse">
    <p>Duis nec nullam volutpat diam. Leo mauris blandit mi ac imperdiet posuere. Est facilisi nisi, turpis viverra mi
        arcu.</p>
